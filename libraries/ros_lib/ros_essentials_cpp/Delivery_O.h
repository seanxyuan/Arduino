#ifndef _ROS_ros_essentials_cpp_Delivery_O_h
#define _ROS_ros_essentials_cpp_Delivery_O_h
...
namespace ros_essentials_cpp
{
  ...
  class Delivery_O : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "ros_essentials_cpp/Delivery_O"; };

#ifndef _ROS_ros_essentials_cpp_Carbon_O_h
#define _ROS_ros_essentials_cpp_Carbon_O_h
...
namespace ros_essentials_cpp
{
  ...
  class Carbon_O : public ros::Msg
  {
    ...
    const char * getType(){ return "ros_essentials_cpp/Carbon_O"; };

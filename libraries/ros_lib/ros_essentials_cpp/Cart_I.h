#ifndef _ROS_ros_essentials_cpp_Cart_I_h
#define _ROS_ros_essentials_cpp_Cart_I_h
...
namespace ros_essentials_cpp
{
  ...
  class Cart_I : public ros::Msg
  {
    ...
    const char * getType(){ return "ros_essentials_cpp/Cart_I"; };
